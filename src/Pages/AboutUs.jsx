...
const AboutUs = () => {
  ...
  <input type="email" className='bg-gray-200 w-4/5 px-3 outline-none py-2' name="input2"
        value={inputValues.input2 || ''}
        onChange={handleChange} placeholder='Email'/>
  <textarea className='bg-gray-200 w-4/5 px-3 mt-5 outline-none' 
        value={inputValues.postContent || ''}
        onChange={handleChange}name="postContent" placeholder='Make a report of a problem,solution or an Idea' rows={7} cols={40} />
 
<button className="bg-sky-500 hover:bg-sky-400 duration-500 font-bold w-4/5 py-3 mt-4 text-white" onClick={(e)=>handleSubmit(e)}>Submit</button>
      </form>
